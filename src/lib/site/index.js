 ...
 */
const WHATSAPP_NUMBER = import.meta.env.VITE_WHATSAPP_NUMBER?.replace(/[^0-9]/g, "") || "919886100565";
export const siteConfig = {
    ...
    description: "Authentic Vedic astrology consultations, birth chart analysis, sacred homams, and spiritual remedies by experienced Vedic astrologer Sampath Kumara.",
    ...
    location: "No 100 21 st main 8thCross Rajarajeshwari nagar Bengaluru - 560098",
    workingHours: "Mon – Sun · 8:00 AM – 9:00 PM IST",
    mapQuery: "No 100 21 st main 8thCross Rajarajeshwari nagar Bengaluru - 560098",
    social: {
    ...
    disclaimer: "Astrology provides spiritual guidance and indicative insights. Predictions are not guaranteed. For medical, legal, or financial decisions, please consult qualified professionals.",
};
