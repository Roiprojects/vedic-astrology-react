...
const commonBookingInstructions =
  "Share your name, nakshatra/rashi (or birth details) and preferred date via the booking form or WhatsApp. Guruji confirms an auspicious muhurta, performs the homam with proper Vedic procedure, and sends prasadam details and photos/updates. Payment via Razorpay, UPI, or screenshot upload.";
...
const commonHomamFaqs = [
  ...
  },
  {
    ...
    answer:
      "Submit the booking form or message on WhatsApp. Once an auspicious date is confirmed, pay via Razorpay, UPI, or upload a payment screenshot. You will receive confirmation and updates.",
  },
  {
